...
tools allow operations team to treat service provisioning and deployment in a 
similar fashion as developers manage the software code. Furtheremore, IaC 
improves repeteability and reliability of **Service** deployments.

* **[SvcQC.Aud01]** Production-ready **Service** SHOULD be deployed as a 
workable system with the minimal user or system administrator interaction
leveraging Infrastructure as Code (IaC) tools.

* **[SvcQC.Aud02]** IaC SHOULD be validated by specific (unit) testing 
...
* **[SvcQC.Mon01]** The **Service** in an operational production state SHOULD
  ...
  * **[SvcQC.Mon01.2]** The **Service** public APIs MUST be monitored. Use Functional tests of
  criteria [SvcQC.Fun01.2].
  * **[SvcQC.Mon01.3]** The **Service** Web interface MAY be monitored.Use Functional
  tests of criteria [SvcQC.Fun01.3].
* **[SvcQC.Mon02]** The **Service** MUST be monitored for for security related
  criteria:
  ...
  * **[SvcQC.Mon02.2]** The **Service** SHOULD be monitored with Dynamic
  Application Security Testing (DAST). Use Security tests of criteria [SvcQC.Sec02].
* **[SvcQC.Mon03]** The **Service** MUST be monitored for infrastructure-related
  criteria:
  * **[SvcQC.Mon03.1]** IaC tests of criteria [SvcQC.Aud02] SHOULD be reused as
