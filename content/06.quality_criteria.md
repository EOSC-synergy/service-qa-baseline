...
Web services commonly use an application programming interface (API) to expose
...
presence of such API specification.

* **[SvcQC.Api01]** API testing MUST cover the validation of the features
outlined in the specification (aka contract testing).
