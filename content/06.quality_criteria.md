...
**REVIEW - criteria here is complementary to SQA baseline**
...
* **[SvcQC.Sec06]** The **Service** SHOULD be audited in accordance with the
  ...
  * **[SvcQC.Sec06.2]** Interactive Application Security Testing (IAST)
    ...
    be performed to software components in an operating state, while Functional Testing **[SvcQC.Fun]**,
    is running.
...
* **[SvcQC.Doc07]** Documentation MUST be produced according to the
  ...
  * **[SvcQC.Doc07.2]** Deployment and Administration:
