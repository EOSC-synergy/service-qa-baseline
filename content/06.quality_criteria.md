...
## 6.1. Automated Deployment [SvcQC.Aud]
...
* **[SvcQC.Int02]** Integration testing **MUST NOT** rely on non-operational or out-of-the-warranty services.
  ...
  * **[SvcQC.Int02.1]** On lack of automation, pilot service infrastructures or local testbeds
    **MAY** be used.

  * **[SvcQC.Int02.2]** In the presence of CI environments, integration tests **SHOULD** be suitable for
...
## 6.4. Functional tests [SvcQC.Fun]
