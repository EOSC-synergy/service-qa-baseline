...
[@http://www.swebok.org]. *Stress testing is a subset of Performance testing*
...
measured in terms of its ability to scale up *and/or* scale out the number of user requests or
other such performance measure attributes, through an increase in the amount of available resources.
The definition is based on [@doi:10.1145/2737182.2737185]. *Scalability testing is a subset of
Performance testing*.
...
[@doi:10.1186/s13677-019-0134-y]. *Elasticity testing is a subset of Performance testing*.
...
* **[SvcQC.Per03]** Scalability testing **MAY** be carried out to check the **Service** ability to
  scale up *and/or* scale out when its load reaches the limits.
